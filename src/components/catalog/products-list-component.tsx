...
import {OrderItems, PageRequest, PageResponse, Products} from "@/lib/models";
...
export default function ProductsListComponent(props: Props) {
    ...
    useEffect(() => {
        setPageRequest({...pageRequest, filters: [...pageRequest.filters, { field: 'categoryId', value: [String(props.categoryId)], operator: 'EQUAL' }]})
    }, [props.categoryId])
